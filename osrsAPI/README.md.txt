...
After it is run it will prompt you for an account name to use. Currently there are 4 types of acccounts one can have, a Default, Ironman, Hardcore Ironman, Ultimate Ironman. As there are different hiscores for each type of account you can filter them out this way to get further filters by type. 
...
For the purposes of this lab I have chosen to use an Ironman account specifically as they will generally have less traffic and will almost always generate the data needed. All Ironman account names can be found here on these hiscores: 
